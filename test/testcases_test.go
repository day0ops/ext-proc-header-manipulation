...
import (
	...
	"github.com/day0ops/ext-proc-header-manipulation/pkg/server"
	extproctest "github.com/day0ops/ext-proc-header-manipulation/test"
...
func (suite *IntegrationTestSuite) SetupSuite() {
	...
	if err := suite.container.Run(suite.ctx, "quay.io/solo-io/envoy-gloo:1.34.0-patch0"); err != nil {
		log.Fatal(err)
	}
